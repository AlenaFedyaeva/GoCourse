...
func helpCalc(){
	fmt.Println("HELP\nОсновные функции: \n1) */+-%")
	fmt.Println("2) Сложные выражения нужно брать в круглые скобки ()")
	fmt.Println("3) Аргументы следущих функций надо брать в круглые скобки()")
